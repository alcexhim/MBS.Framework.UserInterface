...
namespace MBS.Framework.UserInterface.Engines.GTK3.Dialogs
{
	...
	public class AppChooserDialogImplementation : GTKDialogImplementation
	{
		...
		protected override GTKNativeControl CreateDialogInternal(Dialog dialog, List<Button> buttons)
		{
			...
			IntPtr handle = Internal.GTK.Methods.GtkAppChooserDialog.gtk_app_chooser_dialog_new_for_content_type((Engine as GTK3Engine).CommonDialog_GetParentHandle(dlg), Internal.GTK.Constants.GtkDialogFlags.Modal, dlg.ContentType);
