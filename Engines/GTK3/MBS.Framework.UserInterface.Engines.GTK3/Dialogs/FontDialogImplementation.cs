...
namespace MBS.Framework.UserInterface.Engines.GTK3.Dialogs
{
	...
	public class FontDialogImplementation : GTKDialogImplementation
	{
		...
		protected override GTKNativeControl CreateDialogInternal(Dialog dialog, List<Button> buttons)
		{
			...
			IntPtr handle = Internal.GTK.Methods.GtkFontChooserDialog.gtk_font_dialog_new(title, (Engine as GTK3Engine).CommonDialog_GetParentHandle(dlg), !dlg.AutoUpgradeEnabled);
