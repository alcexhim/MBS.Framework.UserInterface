...
namespace MBS.Framework.UserInterface.Engines.GTK3
{
	public struct GType : IEquatable<GType>
	{
		...
		static GType()
		{
			...
			Engines.GTK3.Internal.GObject.Methods.g_type_init();
		...
		{
			return new GType(Engines.GTK3.Internal.GObject.Methods.g_type_from_name(native_name));
		}
		...
		public static Type LookupType(IntPtr typeid)
		{
			...
			string cname = Engines.GTK3.Internal.GObject.Methods.g_type_name(typeid);
