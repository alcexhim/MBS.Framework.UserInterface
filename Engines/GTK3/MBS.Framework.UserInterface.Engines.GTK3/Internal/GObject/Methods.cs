...
using static MBS.Framework.UserInterface.Engines.GTK3.Internal.GLib.Constants;

namespace MBS.Framework.UserInterface.Engines.GTK3.Internal.GObject
{
	internal static class Methods
	{
		public const string LIBRARY_FILENAME = "gobject-2.0";

		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr> c_handler)
		{
		...
		[DllImport(LIBRARY_FILENAME)]
		public static extern uint g_signal_connect_data(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr> c_handler, IntPtr data, Delegates.GClosureNotify destroy_data, Constants.GConnectFlags connect_flags);
		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr> c_handler, IntPtr data)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, data, null, Constants.GConnectFlags.None);
		}
		public static uint g_signal_connect_after(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.ConnectAfter);
		}

		public static uint g_signal_connect_after(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr> c_handler, IntPtr data)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, data, null, Constants.GConnectFlags.ConnectAfter);
		}

		#region Action<IntPtr, bool>
		[DllImport(LIBRARY_FILENAME)]
		public static extern uint g_signal_connect_data(IntPtr instance, string detailed_signal, Action<IntPtr, bool> c_handler, IntPtr data, Delegates.GClosureNotify destroy_data, Constants.GConnectFlags connect_flags);

		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Action<IntPtr, bool> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.None);
		}
		public static uint g_signal_connect_after(IntPtr instance, string detailed_signal, Action<IntPtr, bool> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.ConnectAfter);
		}
		#endregion

		#region Action<IntPtr, string>
		[DllImport(LIBRARY_FILENAME)]
		public static extern uint g_signal_connect_data(IntPtr instance, string detailed_signal, Action<IntPtr, string> c_handler, IntPtr data, Delegates.GClosureNotify destroy_data, Constants.GConnectFlags connect_flags);

		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Action<IntPtr, string> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.None);
		}
		public static uint g_signal_connect_after(IntPtr instance, string detailed_signal, Action<IntPtr, string> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.ConnectAfter);
		}
		#endregion

		#region Func<IntPtr, string, bool>
		[DllImport(LIBRARY_FILENAME)]
		public static extern uint g_signal_connect_data(IntPtr instance, string detailed_signal, Func<IntPtr, string, bool> c_handler, IntPtr data, Delegates.GClosureNotify destroy_data, Constants.GConnectFlags connect_flags);

		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Func<IntPtr, string, bool> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.None);
		}
		public static uint g_signal_connect_after(IntPtr instance, string detailed_signal, Func<IntPtr, string, bool> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.ConnectAfter);
		}
		#endregion

		#region Action<IntPtr, IntPtr, IntPtr>
		[DllImport(LIBRARY_FILENAME)]
		public static extern uint g_signal_connect_data(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr, IntPtr> c_handler, IntPtr data, Delegates.GClosureNotify destroy_data, Constants.GConnectFlags connect_flags);

		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr, IntPtr> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.None);
		}
		public static uint g_signal_connect_after(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr, IntPtr> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.ConnectAfter);
		}
		#endregion
		...
		#region Action<IntPtr, IntPtr, int, string, IntPtr>
		[DllImport(LIBRARY_FILENAME)]
		public static extern uint g_signal_connect_data(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr, int, string, IntPtr> c_handler, IntPtr data, Delegates.GClosureNotify destroy_data, Constants.GConnectFlags connect_flags);

		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr, int, string, IntPtr> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.None);
		}
		public static uint g_signal_connect(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr, int, string, IntPtr> c_handler, IntPtr data)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, data, null, Constants.GConnectFlags.None);
		}
		public static uint g_signal_connect_after(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr, int, string, IntPtr> c_handler)
		{
			return g_signal_connect_data(instance, detailed_signal, c_handler, IntPtr.Zero, null, Constants.GConnectFlags.ConnectAfter);
		}
		#endregion
		...
		[DllImport(LIBRARY_FILENAME)]
		public static extern uint g_signal_connect_object(IntPtr instance, string detailed_signal, Action<IntPtr, IntPtr> c_handler, IntPtr gobject, Constants.GConnectFlags connect_flags);
