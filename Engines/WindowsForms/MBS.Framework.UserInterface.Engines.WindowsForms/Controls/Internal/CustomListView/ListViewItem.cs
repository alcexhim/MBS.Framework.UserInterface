...
namespace MBS.Framework.UserInterface.Engines.WindowsForms.Controls.Internal.CustomListView
{
	public class ListViewItem
	{
		...
		{
			internal ListViewControl mvarParent = null;
			...
			{
				foreach (ListViewItem lvi in this)
				{
					lvi.Parent = null;
				}
				base.ClearItems();
		...
		public ListViewControl Parent
		{
			get { return mvarParent; }
			internal set
			{
				mvarParent = value;
				mvarItems.mvarParent = value;
			}
		}
		...
		/// <see cref="MBS.Framework.UserInterface.Engines.WindowsForms.Controls.Internal.CustomListView.ListViewControl.ShowItemTooltips" /> is set to
		/// true.
		/// </summary>
		...
		public bool Remove()
		{
			if (!mvarParent.Items.Contains(this)) return false;

			mvarParent.Items.Remove(this);
			return true;
		}
	}
}
