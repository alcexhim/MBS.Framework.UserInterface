...
namespace UniversalWidgetToolkit.Controls.Ribbon
{
	namespace Native
	{
	...
	public class RibbonControl : SystemControl
	{
		...
		internal protected override void OnMouseDoubleClick (UniversalWidgetToolkit.Input.Mouse.MouseEventArgs e)
		{
